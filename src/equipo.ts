...
export class Equipo extends Participante {
  ...
  perfil(): string {
    ...
    return `ID: ${this.g_id}, Nombre: ${this.g_name}, País: ${this.g_pais}, Fecha Inscripción: ${this.g_fechaInsc.toLocaleDateString('es-ES')}, Puntuación: ${this.g_puntuacion}, Sponsor: ${this.sponsor}, Tags: ${gametag}`;
  }
}
